...
from .views import (
    ...
    ExerciseCalibrationView,
    ExerciseWeightScaleView,
    GenerateProgramView,
    ReplaceTrainingExerciseView,
    SaveExerciseCalibrationView,
...
urlpatterns = [
    ...
    path("exercise-weight-scale/<int:profile_id>/<int:training_exercise_id>/", ExerciseWeightScaleView.as_view()),
    path("exercise-calibration/<int:profile_id>/<int:training_exercise_id>/", ExerciseCalibrationView.as_view()),
    path("exercise-calibration/", SaveExerciseCalibrationView.as_view()),
